...
\begin{enumerate}
    ...
    \item{\textbf{Leistungen in DS}}
        ...
        \end{flalign*}
        $\ul{S}_{3 \sim}:$ 3-Phasen-Scheinleistung\\
...
\end{center}
% \begin{flalign*}
%     \cos \varphi &= 0,95 \rightarrow \varphi = 18,1949\degree &\\
%     \cos \varphi &= 0,9 \rightarrow \varphi = 25,8419\degree &\\
%     \cos \varphi &= 0,85 \rightarrow \varphi = 31,7883\degree &\\
%     \cos \varphi &= 0,8 \rightarrow \varphi = 36,8699\degree &
% \end{flalign*}
